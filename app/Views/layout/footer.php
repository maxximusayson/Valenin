...
<footer class="bg-white border-t py-10">
  <div class="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
    ...
    <div class="flex flex-col items-center md:items-start gap-4">
      <!-- VALENIN Logo Text -->
      <div class="text-[#084F3F] text-2xl font-semibold tracking-widest">
        VALENIN
      </div>
    ...
    <div class="flex flex-col items-center md:items-end gap-3 w-full md:w-auto">
      <!-- Label -->
      <span class="text-sm font-semibold text-[#084F3F] text-center md:text-right">
      ...
      <form class="flex w-full max-w-sm">
        ...
        <button type="submit" class="bg-[#084F3F] text-white px-4 rounded-r-md hover:bg-[#1ca759] transition">
          SUBMIT
        </button>
      </form>
    </div>
